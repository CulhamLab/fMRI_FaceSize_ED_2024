...
for eye = ["l" "r"]
    for distance = distances
        ...
        switch eye
            case "l"
                img = insertText(img, [(0.4 * img_width) y], "Fixation " + distance, FontSize=font_size, TextBoxColor=[1 1 1]*(128/255), FontColor=[0 0 0]);
            case "r"
                img = insertText(img, [(0.5 * img_width) y], "Fixation " + distance, FontSize=font_size, TextBoxColor=[1 1 1]*(128/255), FontColor=[0 0 0]);
        end
